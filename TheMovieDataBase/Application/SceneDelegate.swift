...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        mainNavigator.destinations = [
            ...
            BottomNavigationBar.Item.Destination(text: "Library", icon: UIImage(systemName: "popcorn"), viewController: Library(destinations: [
                TopNavigationBar.Item.Destination(title: "Movies", viewController: SavedMovies()),
                TopNavigationBar.Item.Destination(title: "TV Shows", viewController: SavedTvShows())
            ]))
        ]
